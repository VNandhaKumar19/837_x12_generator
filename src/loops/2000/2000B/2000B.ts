 ...
 */
export function generate2000B(claimData: RequestBody, payerAddress: Address | null, isWorkComp: boolean = false) {
    const data = [
        {
            "Segment": "HL",
        ...
        { "loop2010BA": generate2010BA(claimData?.subscriber, claimData?.dependent, claimData?.claimInformation, isWorkComp) },
